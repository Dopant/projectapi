        ...
        req.getConnection(function(err, conn) {
            if (err) {
                ...
                var sql =  "select id,registry_no,job_card,brand,serial_no," +
                    "date_format(fitted_on_date,'%Y-%m-%d') as fitted_on_date,fitted_on_mileage," +
                    "date_format(taken_off_date,'%Y-%m-%d') as taken_off_date,taken_off_mileage," +
    ...
    try {
        req.getConnection(function(err, conn) {
            if (err) {
                ...
                var sql =  "select id,registry_no,engine,mileage,gear_box,back_axle,date_format(date,'%Y-%m-%d') as date," +
    ...
    try {
        req.getConnection(function(err, conn) {
            if (err) {
                ...
                var sql =  "select id,registry_no,job_number,mileage,material,date_format(date,'%Y-%m-%d') as date," +
        ...
        req.getConnection(function(err, conn) {
            if (err) {
                ...
                var sql =  "select id,registry_no,current_mileage,cumulative_mileage,fuel," +
                    "fuel_rate,oil,oil_rate,date_format(date,'%Y-%m-%d') as date,remarks" +
