        ...
        req.getConnection(function(err, conn) {
            if (err) {
                ...
                var sql = "select transaction_id as criv_no, type as type, item_type as item_type,item as item, unit_cost as unit_cost," +
                    "quantity as quantity,total_cost as total_cost,company as comp_bus,person as person,station as station,date_format(date,'%Y-%m-%d') as date from intake_stores " +
                    ...
                    "quantity as quantity,total_cost as total_cost,registry_no as comp_bus,person as person,station as station,date_format(date,'%Y-%m-%d') as date from discharge_stores " +
        ...
        req.getConnection(function(err, conn) {
            if (err) {
                ...
                var sql =  "select id,transaction_id,type,item_type,item,unit_cost," +
                    "quantity,total_cost,company,person,station,date_format(date,'%Y-%m-%d') as date" +
        ...
        req.getConnection(function(err, conn) {
            if (err) {
                ...
                var sql =  "select  id,transaction_id,type,item_type,item,unit_cost,quantity,total_cost,registry_no," +
                    "person,station, date_format(date,'%Y-%m-%d') as date from discharge_stores where" +
