$(function () {
    ...
    $('#intakeReportButton ').on('click',function (event) {
        event.preventDefault();

        var intakeReportTableBody = document.getElementById('intakeReportTableBody');
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    $('#intakeReportTableBody').html('');
                    $.ajax({
                        method: 'GET',
                        url:'/storesIntakeReport',
                        data:{
                            'from':from.value,
                            'to':to.value,
                        ...
                        success: function (data){
                            ...
                            for ( let i = 0 ; i < data.length; i++ ){
                                ...
                                var company = dataCell(data[i].company);
                                ...
                                $('#intakeReportTableBody').append(tableRow);
                            }
                        },
