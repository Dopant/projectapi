                ...
                if (willDelete) {
                    $.ajax({
                        ...
                        data: {
                            ...
                            job_card : $jobCard.val(),
                            brand :$tyredropdown.val(),
                            serial_no : $serial_no.val(),
                            fitted_on_date :$onDate.val(),
                            fitted_on_mileage : $onMileage.val(),
                            taken_off_date : $offDate.val(),
                            taken_off_mileage : $offMileage.val(),
